...
The `cisco-cii-adsync` maintainers take all security issues in the project
seriously. Thank you for improving the security of `cisco-cii-adsync`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`cisco-cii-adsync` leverages GitHub's private vulnerability reporting.
